...
python3 -c 'import json,sys; r=json.load(open(sys.argv[1])); print(r); assert r["checks"] >= 17 and not r["failures"], "Native navigation checks failed"' "$OUT/navigation-checks.json"
